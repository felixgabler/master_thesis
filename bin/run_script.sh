...
#       --train_file="/tmp/global2/vikram/felix/master_thesis/data/disprot/flDPnn/flDPnn_Training_Annotation.txt" \
#       --val_file="/tmp/global2/vikram/felix/master_thesis/data/disprot/flDPnn/flDPnn_Validation_Annotation.txt" \
#       &> out_tune_bert
